...
<head>
    ...
    <!-- ===============================================--><!--    Favicons--><!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo base_url('landing_page/img/favicons/apple-touch-icon.png') ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo base_url('landing_page/img/favicons/favicon-32x32.png') ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('landing_page/img/favicons/favicon-16x16.png') ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('landing_page/img/favicons/favicon.ico') ?>">
    <link rel="manifest" href="<?php echo base_url('landing_page/img/favicons/manifest.json') ?>">
    <meta name="msapplication-TileImage" content="<?php echo base_url('landing_page/img/favicons/mstile-150x150.png') ?>">
    <meta name="theme-color" content="#ffffff">

    <!-- ===============================================--><!--    Stylesheets--><!-- ===============================================-->
    <link rel="stylesheet" href="<?php echo base_url('vendors/swiper/swiper-bundle.min.css') ?>">
    ...
    <link href="<?php echo base_url('landing_page/css/theme.min.css') ?>" rel="stylesheet" id="style-default">
    <link href="<?php echo base_url('landing_page/css/user-rtl.min.css') ?>" rel="stylesheet" id="user-style-rtl">
    <link href="<?php echo base_url('landing_page/css/user.min.css') ?>" rel="stylesheet" id="user-style-default">
...
<body>
    ...
    <main class="main" id="top">
        <div class="content">
            <nav class="navbar navbar-expand-md fixed-top" id="navbar" data-navbar-soft-on-scroll="data-navbar-soft-on-scroll">
                <div class="container-fluid px-0"><a href="/"><img class="navbar-brand w-75 d-md-none" src="<?php echo base_url('landing_page/img/logos/logo.svg') ?>" alt="logo" /></a>
                    <a class="navbar-brand fw-bold d-none d-md-block" href="/">Brainwave.io</a>
                    <a class="btn btn-primary btn-sm ms-md-x1 mt-lg-0 order-md-1 ms-auto" href="<?php echo base_url('login') ?>"><i class="fa-solid fa-right-to-bracket"></i> Login</a>
                    <button class="navbar-toggler border-0 pe-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-content" aria-controls="navbar-content" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            ...
            <div data-bs-target="#navbar" data-bs-spy="scroll" tabindex="0">
                        ...
                        <div class="container">
                            <div class="row gy-4 gy-md-8 pt-9 pt-lg-0">
                                <div class="col-lg-6 text-center text-lg-start">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-center justify-content-lg-start gap-2 position-relative z-2"><a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="<?php echo base_url('landing_page/img/logos/App_Store.webp') ?>" alt="<?php echo base_url('landing_page/img/logos/App_Store.webp') ?>" /></a><a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="<?php echo base_url('landing_page/img/logos/Play_Store.webp') ?>" alt="<?php echo base_url('landing_page/img/logos/Play_Store.webp') ?>" /></a></div>
                                </div>
                                <div class="col-lg-6 position-lg-relative">
                                    <div class="position-lg-absolute z-1 text-center"><img class="img-fluid chat-image" src="<?php echo base_url('landing_page/img/Hero/Frame.webp') ?>" alt="" />
                                        <div class="position-absolute dots d-none d-md-block"> <img class="img-fluid w-50 w-lg-75" src="<?php echo base_url('landing_page/img/illustrations/Dots.webp') ?>" alt="" /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="position-absolute bottom-0 start-0 end-0 z-1"><img class="wave mb-md-n2" src="<?php echo base_url('landing_page/img/illustrations/Wave.svg') ?>" alt="" />
                ...
                <section class="container mb-8 mb-lg-13" id="about">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6 col-xl-7"><img class="img-fluid" src="<?php echo base_url('landing_page/img/Hero/Team.webp') ?>" alt="" /></div>
                ...
                <section class="container mb-8 mb-lg-13">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6 col-xl-5 order-lg-1"><img class="img-fluid" src="<?php echo base_url('landing_page/img/Hero/Collaborator.webp') ?>" alt="" /></div>
                ...
                <section class="experience position-relative overflow-hidden" id="service">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <div class="position-relative z-1 text-center mb-8 mb-lg-9 video-player-paused" data-video-player-container="data-video-player-container"><video class="w-100 h-100 rounded-4" src="<?php echo base_url('landing_page/video/Tech_video.mp4') ?>" poster="<?php echo base_url('landing_page/img/Hero/experiences.webp') ?>" type="video/mp4" data-video-player="data-video-player"></video>
                                    <div class="overlay position-absolute top-0 bottom-0 start-0 end-0 rounded-4 bg-1100 object-cover" data-overlay="data-overlay"> </div><button class="btn play-button position-absolute justify-content-center align-items-center bg-white rounded-circle cursor-pointer" data-play-button="data-play-button"> <img class="play-icon w-25" src="<?php echo base_url('landing_page/img/illustrations/play-solid.svg') ?>" alt="" data-play-icon="data-play-icon" /><img class="pause-icon w-25" src="<?php echo base_url('landing_page/img/illustrations/pause-solid.svg') ?>" alt="" data-pause-icon="data-pause-icon" /></button>
                                    <div class="position-absolute dots d-none d-sm-block"><img class="img-fluid w-100" src="<?php echo base_url('landing_page/img/illustrations/Dots.webp') ?>" alt="" /></div>
                                </div>
                            </div>
                            <div class="col-md-8 col-lg-7">
                            ...
                            <div class="col-12">
                                <div class="row gy-4 g-md-3 pb-8 pb-lg-11 px-1">
                                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="<?php echo base_url('landing_page/img/icons/roadmap.svg') ?>" alt="" />
                                        <div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="<?php echo base_url('landing_page/img/icons/users-wm.svg') ?>" alt="" />
                                        <div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="<?php echo base_url('landing_page/img/icons/share-91.svg') ?>" alt="" />
                                        <div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="<?php echo base_url('landing_page/img/icons/video_meeting.svg') ?>" alt="" />
                                        <div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="<?php echo base_url('landing_page/img/icons/opening-times.svg') ?>" alt="" />
                                        <div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="<?php echo base_url('landing_page/img/icons/card-favorite.svg') ?>" alt="" />
                                        <div>
                    ...
                    <div class="position-absolute top-0 start-0 end-0">
                        <div class="bg-white py-3 py-md-9 py-xl-10"> </div><img class="wave" src="<?php echo base_url('landing_page/img/illustrations/Wave_2.svg') ?>" alt="" />
                    </div>
                </section>
                                                ...
                                                <div class="col-12 swiper-slide">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-1">
                                                            <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="<?php echo base_url('landing_page/img/feedback/reviewer_1.webp') ?>" alt="" /></div>
                                                ...
                                                <div class="col-12 swiper-slide">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-2">
                                                            <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="<?php echo base_url('landing_page/img/feedback/reviewer_2.webp') ?>" alt="" /></div>
                                                            <div class="text-center text-lg-start">
                                                ...
                                                <div class="col-12 swiper-slide">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-3">
                                                            <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="<?php echo base_url('landing_page/img/feedback/reviewer_3.webp') ?>" alt="" /></div>
                                                            <div class="text-center text-lg-start">
                                                ...
                                                <div class="col-12 swiper-slide">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-4">
                                                            <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="<?php echo base_url('landing_page/img/feedback/kakashi.webp') ?>" alt="" /></div>
                                                            <div class="text-center text-lg-start">
                                                ...
                                                <div class="col-12 swiper-slide">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-5">
                                                            <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="<?php echo base_url('landing_page/img/feedback/obito.webp') ?>" alt="" /></div>
                                                            <div class="text-center text-lg-start">
                ...
                <section class="bg-300 position-relative z-0" id="contact">
                    ...
                    <div class="position-absolute bottom-0 end-0 z-n1 d-none d-lg-block"><img src="<?php echo base_url('landing_page/img/illustrations/Green_dots.svg') ?>" alt="" /></div>
                    <div class="position-relative bottom-0 start-0 z-1"><img class="img-fluid w-100" src="<?php echo base_url('landing_page/img/illustrations/Wave_3.svg') ?>" alt="" /></div>
                </section>
            </div>
            <button class="btn scroll-to-top text-white rounded-circle d-flex justify-content-center align-items-center bg-primary" data-scroll-top="data-scroll-top"><i class="fa-solid fa-arrow-up"></i></button>
                    ...
                    <div class="row gy-4 g-md-3 border-bottom pb-8 pb-lg-9 justify-content-center">
                        ...
                        <div class="col-6 col-md-3 d-md-flex flex-column align-items-md-end pe-md-0">
                            <div>
                                ...
                                <div class="mb-1 mb-lg-2"> <a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="<?php echo base_url('landing_page/img/logos/App_Store.webp') ?>" alt="<?php echo base_url('landing_page/img/logos/App_Store.webp') ?>" /></a></div><a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="<?php echo base_url('landing_page/img/logos/Play_Store.webp') ?>" alt="<?php echo base_url('landing_page/img/logos/Play_Store.webp') ?>" /></a>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php echo base_url('landing_page/js/theme.js') ?>"></script>
